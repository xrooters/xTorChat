...
/** The default XMPP resource (e.g. username@example.com/xTorChat) */
@property (class, readonly) NSString* xmppResource;

/** Email for user feedback e.g. support@xTorChat.org */
...
/** Project URL e.g. https://xTorChat.org */
@property (class, readonly) NSURL* projectURL;

/** Share Base URL e.g. https://xTorChat.org/i/# */
...
/** If enabled, will allow the in-app-purchase donations UI. This includes hardcoded elements designed for upstream xTorChat. */
