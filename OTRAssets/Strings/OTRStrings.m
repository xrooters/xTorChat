...
/** "Add friend", The title for the view to add a buddy */
NSString* ADD_BUDDY_STRING() { return [OTRLanguageManager translatedString:@"Add friend"]; }
...
/** "Congrats! You can chat with %@.", Notification message when buddy has approved you */
NSString* BUDDY_APPROVED_STRING() { return [OTRLanguageManager translatedString:@"Congrats! You can chat with %@."]; }
...
/** "xTorChat Push", Title for xTorChat Push (this probably doesnt need to be translated) */
NSString* XTORCHAT_PUSH_STRING() { return [OTRLanguageManager translatedString:@"xTorChat Push"]; }
/** "Conversations", Title for chats view */
NSString* CHATS_STRING() { return [OTRLanguageManager translatedString:@"Conversations"]; }
/** "Chat", Title for chat view */
NSString* CHAT_STRING() { return [OTRLanguageManager translatedString:@"Chat"]; }
/** "Contacts", Label for text field where you compose a new message */
NSString* COMPOSE_STRING() { return [OTRLanguageManager translatedString:@"Contacts"]; }
...
/** "Are you sure to delete?", Ask user if they want to delete the stored account information */
NSString* DELETE_ACCOUNT_MESSAGE_STRING() { return [OTRLanguageManager translatedString:@"Are you sure to delete?"]; }
...
/** "Your donation will help fund the continued development of xTorChat.", Message shown when about to donate */
NSString* DONATE_MESSAGE_STRING() { return [OTRLanguageManager translatedString:@"Your donation will help fund the continued development of xTorChat."]; }
...
/** "Error occured while sending message", Title of error message pop-up box */
NSString* ERROR_STRING() { return [OTRLanguageManager translatedString:@"Error occured while sending message"]; }
...
/** "File not found.", Error occured while sending message */
...
/** "Because the database contents is encrypted with your passphrase, you've lost access to your data and will need to delete and reinstall xTorChat to continue. Password managers like 1Password or MiniKeePass can be helpful for generating and storing strong passwords.", Text describing what happens when the user has forgotten the passphrase */
NSString* FORGOT_PASSPHRASE_INFO_STRING() { return [OTRLanguageManager translatedString:@"Because the database contents is encrypted with your passphrase, you've lost access to your data and will need to delete and reinstall xTorChat to continue. Password managers like 1Password or MiniKeePass can be helpful for generating and storing strong passwords."]; }
...
/** "Manage xTorChat Push account", Title for button to manage xTorChat Push account */
NSString* MANAGE_XTORCHAT_PUSH_ACCOUNT_STRING() { return [OTRLanguageManager translatedString:@"Manage xTorChat Push account"]; }
...
/** "waiting for approval", String for XMPP buddies when adding buddy is pending */
NSString* PENDING_APPROVAL_STRING() { return [OTRLanguageManager translatedString:@"waiting for approval"]; }
/** "Gallery", Label for button to open up photo library and choose photo */
NSString* PHOTO_LIBRARY_STRING() { return [OTRLanguageManager translatedString:@"Gallery"]; }
...
/** "Accounts", title for contacts profile view */
NSString* Profile_String() { return [OTRLanguageManager translatedString:@"Accounts"]; }
...
/** "", String to let user know a certain field like a password is required to create an account */
NSString* REQUIRED_STRING() { return [OTRLanguageManager translatedString:@""]; }
...
/** "Type your message", The placeholder text in the chat view where the message should go */
NSString* SEND_ENCRYPTED_STRING() { return [OTRLanguageManager translatedString:@"Type your message"]; }
...
/** "Type your message", The placeholder text in the chat view where the message should go */
NSString* SEND_PLAINTEXT_STRING() { return [OTRLanguageManager translatedString:@"Type your message"]; }
...
/** "Accounts", Title for the Settings screen */
NSString* SETTINGS_STRING() { return [OTRLanguageManager translatedString:@"Accounts"]; }
...
/** "New Account", title label for signing up for a new account */
NSString* SIGN_UP_STRING() { return [OTRLanguageManager translatedString:@"New Account"]; }
...
/** "i.e: xTorChatUser", Example of a username using the words user and example */
NSString* XMPP_USERNAME_EXAMPLE_STRING() { return [OTRLanguageManager translatedString:@"i.e: xTorChatUser"]; }
