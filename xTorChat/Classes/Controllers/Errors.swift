...
public extension NSError {
    @objc class func XMPPXMLError(_ error:OTRXMPPXMLError, userInfo:[String:AnyObject]?) -> NSError {
        return self.xTorChatError(error, userInfo: userInfo)
    }
    
    class func xTorChatError(_ error:xTorChaErrorProtocol, userInfo:[String:AnyObject]?) -> NSError {
...
public protocol xTorChaErrorProtocol {
    func code() -> Int
...
extension PushError: xTorChaErrorProtocol {
    func localizedDescription() -> String {
        switch self {
        case .noPushDevice:
...
extension EncryptionError: xTorChaErrorProtocol {
    func localizedDescription() -> String {
        switch self {
...
extension OTRXMPPXMLError: xTorChaErrorProtocol {
...
extension OTROMEMOError: xTorChaErrorProtocol {
    public func code() -> Int {
        return self.rawValue
    }
