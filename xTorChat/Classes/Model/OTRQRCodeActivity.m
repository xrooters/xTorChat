...
{
    return [UIImage otr_imageWithImage:[UIImage imageNamed:@"xTorChat" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil] scaledToSize:[UIActivity otr_defaultImageSize]];
}
