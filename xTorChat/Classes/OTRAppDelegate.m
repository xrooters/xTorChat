...
//  OTRAppDelegate.m
//
//  Created by xTorChat on 8/11/11.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([OTRDatabaseManager existsYapDatabase] && ![[OTRDatabaseManager sharedInstance] hasPassphrase]) {
        ...
        settingsNav.tabBarItem.image = [UIImage imageNamed:@"ic-user" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
        settingsNav.tabBarItem.title = @"Accounts";
        
    
        
        self.conversationViewController.delegate = self.splitViewCoordinator;
        UINavigationController *chatNav = [[UINavigationController alloc] initWithRootViewController:self.conversationViewController];
        chatNav.tabBarItem.image = [UIImage imageNamed:@"ic-chat" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
        chatNav.tabBarItem.title = @"Conversations";
        
        
        OTRComposeViewController * composeViewController = [GlobalTheme.shared composeViewController];
        UINavigationController *composeNav = [[UINavigationController alloc] initWithRootViewController:composeViewController];
        composeNav.tabBarItem.image = [UIImage imageNamed:@"ic-users" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
        composeNav.tabBarItem.title = @"Contacts";
...
//        
        ...
        rootController.viewControllers = [NSArray arrayWithObjects:chatNav,composeNav,settingsNav, nil];
        LCTabBarController *tabBarC = [[LCTabBarController alloc] init];
        
        self.tabbar = tabBarC;
        
        tabBarC.viewControllers = @[chatNav,composeNav,settingsNav];
        ...
        if([accounts count] > 1) {
            ...
            page1.title = @"Welcome to xTorChat";
            page1.titlePositionY = 220;
            page1.bgImage = [UIImage imageNamed:@"intro1" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
            page1.desc = @"xTorChat is an intelligent and secure communications tool, built for individual users. xTorChat makes you communication easy and efficient.";
            page1.descPositionY = 200;
            page1.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon1" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil]];
            page1.titleIconPositionY = 100;
            
            page1.titleColor = [UIColor colorWithRed:255.0f/255.0f
                                               green:255.0f/255.0f
                                                blue:255.0/255.0f
                                               alpha:1.0f];
            page1.descColor = [UIColor colorWithRed:190.0f/255.0f
                                              green:190.0f/255.0f
                                               blue:190.0f/255.0f
                                              alpha:1.0f];
            // custom
            EAIntroPage *page2 = [EAIntroPage page];
            page2.title = @"Anywhere, Anytime, Anyplace";
            page2.titlePositionY = 220;
            page2.bgImage = [UIImage imageNamed:@"intro2" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
            page2.desc = @"xTorChat provides the efficient chat, user can send or receive message anywhere, anytime, anyplace";
            page2.descPositionY = 200;
            page2.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon2" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil]];
            page2.titleIconPositionY = 100;
            
            page2.titleColor = [UIColor colorWithRed:255.0f/255.0f
                                               green:255.0f/255.0f
                                                blue:255.0/255.0f
                                               alpha:1.0f];
            page2.descColor = [UIColor colorWithRed:190.0f/255.0f
                                              green:190.0f/255.0f
                                               blue:190.0f/255.0f
                                              alpha:1.0f];
            
            EAIntroPage *page3 = [EAIntroPage page];
            page3.title = @"Security, Anonymousness, Powerful Encryption";
            page3.titlePositionY = 220;
            page3.bgImage = [UIImage imageNamed:@"intro3" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
            page3.desc = @"xTorChat secures your business and personal chats, files and calls with end-to-end encryption. All data is protected. xTorChat combines strong end-to-end encryption with great user experience, and all the great features to get work done in a team, or to bring friends and families together. ";
            page3.descPositionY = 200;
            page3.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon3" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil]];
            page3.titleIconPositionY = 100;
            
            page3.titleColor = [UIColor colorWithRed:255.0f/255.0f
                                               green:255.0f/255.0f
                                                blue:255.0/255.0f
                                               alpha:1.0f];
            page3.descColor = [UIColor colorWithRed:190.0f/255.0f
                                              green:190.0f/255.0f
                                               blue:190.0f/255.0f
                                              alpha:1.0f];
            ...
            EAIntroView *intro = [[EAIntroView alloc] initWithFrame:tabBarC.view.bounds andPages:@[page1,page2,page3]];
            [intro showInView:tabBarC.view animateDuration:0.0];
        }
        ...
        self.conversationViewController.delegate = self.splitViewCoordinator;
        composeViewController.delegate = self.splitViewCoordinator;
        ...
        splitViewController.viewControllers = @[tabBarC,messagesNavigationController];
        ...
        if ([[[NSProcessInfo processInfo] environment][@"OTRLaunchMode"] isEqualToString:@"xTorChatTestsDemoData"]) {
            [OTRChatDemo loadDemoChatInDatabase];
        } else if ([[[NSProcessInfo processInfo] environment][@"OTRLaunchMode"] isEqualToString:@"xTorChatUITests"]) {
