...
- (void)viewDidLoad
{
    ...
    self.groupBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCompose target:self action:@selector(groupButtonPressed:)];
...
- (void)doneButtonPressed:(id)sender
{
    ...
    if (self.selectedBuddiesIdSet.count > 1) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"xTorChat" message:ENTER_GROUP_NAME_STRING() preferredStyle:UIAlertControllerStyleAlert];
...
- (void) joinGroup:(id)sender {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"xTorChat" message:nil preferredStyle:UIAlertControllerStyleAlert];
    [alertController addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
