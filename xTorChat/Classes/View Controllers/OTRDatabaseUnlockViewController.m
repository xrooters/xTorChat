...
{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"xTorChat" message:FORGOT_PASSPHRASE_INFO_STRING() preferredStyle:UIAlertControllerStyleAlert];
