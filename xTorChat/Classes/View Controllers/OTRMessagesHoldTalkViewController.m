    ...
    [[AVAudioSession sharedInstance] requestRecordPermission:^(BOOL granted) {
        dispatch_async(dispatch_get_main_queue(), ^{
            if (![view isInTouch]) {
                ...
                UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"xTorChat" message:Microphone_Reenable_Please() preferredStyle:UIAlertControllerStyleAlert];
