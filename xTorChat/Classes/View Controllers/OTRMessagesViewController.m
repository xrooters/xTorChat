...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem* cancelBtn = [[UIBarButtonItem alloc] initWithTitle:@"Back"
    ...
    UIImage * image = [UIImage imageNamed:@"chat_back" inBundle:[OTRAssets resourcesBundle] compatibleWithTraitCollection:nil];
...
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapMessageBubbleAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([item isKindOfClass:[OTRImageItem class]]) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"xTorChat" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
        [actions enumerateObjectsUsingBlock:^(UIAlertAction * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            [alert addAction:obj];
        }];
