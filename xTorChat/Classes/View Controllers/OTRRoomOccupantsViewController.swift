...
open class OTRRoomOccupantsViewController: UIViewController {
    ...
    @objc func didPressEditGroupSubject(_ sender: UIControl!, withEvent: UIEvent!) {
        let alert = UIAlertController(title: NSLocalizedString("xTorChat", comment: "Title for change room subject"), message: nil, preferredStyle: UIAlertControllerStyle.alert)
