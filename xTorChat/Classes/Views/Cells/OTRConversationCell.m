...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.conversationLabel.font = [UIFont systemFontOfSize:12];
        self.conversationLabel.textColor = UIColor.grayColor;
        
        self.accountLabel = [[UILabel alloc] init];
        self.accountLabel.font = [UIFont boldSystemFontOfSize:18];
...
- (void)setThread:(id <OTRThreadOwner>)thread
{
    ...
    if (unreadMessages > 0) {
        //unread message
        self.nameLabel.font = [UIFont boldSystemFontOfSize:1];
